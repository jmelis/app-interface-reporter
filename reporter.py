...
def main():
    ...
    store_metrics(metrics, mem_requests, 'mem_requests', value_handler=to_mb)
    ...
    store_metrics(metrics, mem_limits, 'mem_limits', value_handler=to_mb)
    ...
    store_metrics(metrics, cpu_requests, 'cpu_requests')
    ...
    store_metrics(metrics, cpu_limits, 'cpu_limits')
